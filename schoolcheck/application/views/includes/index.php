...
float: right;
font-size: 16px;"> KIST College of Management &nbsp; <a href="#" class="btn btn-primary square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <?php include('studentstatistics.php'); ?>
